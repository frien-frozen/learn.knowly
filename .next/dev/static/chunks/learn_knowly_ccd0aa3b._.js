...
function Dashboard() {
    _s();
    const { push } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$learn$2e$knowly$2f$hooks$2f$useLangRouter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLangRouter"])();
    const [curriculums, setCurriculums] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$learn$2e$knowly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$learn$2e$knowly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            __turbopack_context__.A("[project]/learn.knowly/app/actions/curriculum.ts [app-client] (ecmascript, async loader)").then({
                "Dashboard.useEffect": (mod)=>{
                    mod.getCurriculums().then(setCurriculums);
                }
            }["Dashboard.useEffect"]);
        }
    }["Dashboard.useEffect"], []);
    const getHref = (searchParams, fallback)=>{
...
_s(Dashboard, "PuCvZEvD9xe+Moy4VzTA8bzHtoA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$learn$2e$knowly$2f$hooks$2f$useLangRouter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLangRouter"]
    ];
});
...
//# sourceMappingURL=learn_knowly_ccd0aa3b._.js.map