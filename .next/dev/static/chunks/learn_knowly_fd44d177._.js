...
function SyllabusPage() {
    ...
    const allSubjects = __TURBOPACK__imported__module__$5b$project$5d2f$learn$2e$knowly$2f$utils$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_SUBJECTS"][curriculumSlug] || [];
    const subject = allSubjects.find((s)=>s.slug === subjectSlug);
    const syllabus = subject ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$learn$2e$knowly$2f$utils$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSyllabus"])(subjectSlug, subject.title) : [];
    const [openUnit, setOpenUnit] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$learn$2e$knowly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    if (!subject) {
...
_s(SyllabusPage, "H1/PCb1+H5w0eRzQzHSnZrLhdto=", false, function() {
    return [
...
//# sourceMappingURL=learn_knowly_fd44d177._.js.map