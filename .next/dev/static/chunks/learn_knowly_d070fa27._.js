...
const useGlobalSearch = ()=>{
    _s();
    const searchIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$learn$2e$knowly$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useGlobalSearch.useMemo[searchIndex]": ()=>{
            const index = [];
            Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$learn$2e$knowly$2f$utils$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_CURRICULUMS"]).forEach({
                "useGlobalSearch.useMemo[searchIndex]": ([slug, curr])=>{
                    index.push({
                        id: `curr-${slug}`,
                        type: 'curriculum',
                        title: curr.title,
                    ...
                    subjects.forEach({
                        "useGlobalSearch.useMemo[searchIndex]": (subj)=>{
                            index.push({
                                id: `subj-${subj.slug}`,
                                type: 'subject',
                                title: subj.title,
                            ...
                            const syllabus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$learn$2e$knowly$2f$utils$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSyllabus"])(subj.slug, subj.title);
                            syllabus.forEach({
                                "useGlobalSearch.useMemo[searchIndex]": (unit)=>{
                                    unit.topics.forEach({
                                        "useGlobalSearch.useMemo[searchIndex]": (topic)=>{
                                            index.push({
                                                id: `topic-${topic}`,
                                                type: 'topic',
                                                title: topic,
...
_s(useGlobalSearch, "/X2nqQ+TRLi+N+E1p4dsWPnF4eM=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=learn_knowly_d070fa27._.js.map